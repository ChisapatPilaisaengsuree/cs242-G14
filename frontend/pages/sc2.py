...
with col_h1:
    st.markdown("<div style='font-size: 24px; font-weight: bold; margin-top: 20px; margin-bottom: -5px;'>อาคาร SC2</div>", unsafe_allow_html=True)
...
metrics = [
    ...
    {"label": "เฉลี่ยการใช้งาน", "val": "52%", "unit": "วันนี้", "color": "#111"},
]
    ...
    with c_add:
        ...
        with st.popover(" เพิ่มห้องน้ำ", use_container_width=True):
            ...
            if st.button("ยืนยันการเพิ่มข้อมูล", use_container_width=True, type="primary"):
                ...
                st.session_state.rooms_sc2.append(new_room)
...
# จำลองข้อมูล
rooms = [
    {"name": "SC2 - ชั้น1 - ชาย", "gender": "♂ ชาย", "usage": 95, "cap": "6 ที่", "status": "เต็ม", "color": "#c62828", "bg": "#ffebee"}
]
...
# ข้อมูลในตาราง
for room in st.session_state.rooms_sc2:  # ใช้ข้อมูลจาก Session State
