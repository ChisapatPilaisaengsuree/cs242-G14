...
metrics = [
    ...
    {"label": "เฉลี่ยการใช้งาน", "val": "5%", "unit": "วันนี้", "color": "#111"},
]
    ...
    with c_add:
        ...
        with st.popover(" เพิ่มห้องน้ำ", use_container_width=True):
            ...
            if st.button("ยืนยันการเพิ่มข้อมูล", use_container_width=True, type="primary"):
                ...
                st.session_state.rooms_sc3.append(new_room)
...
# ข้อมูลในตาราง
for room in st.session_state.rooms_sc3:  # ใช้ข้อมูลจาก Session State
